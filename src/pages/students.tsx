...
import { DELETE, GET, POST, PUT } from "../components/Requests";
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div className="flex items-center mb-4 md:mb-0">
              {activeTab === 'students' ? (
                ...
                <BookOpen className="text-emerald-600 mr-3" size={24} />
              )}
            ...
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0">
              <div className="flex p-1 bg-gray-100 rounded-lg mr-4">
                <button
              ...
              <div>
                {activeTab === 'students' ? (
                  <button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 text-white flex items-center p-2 rounded-full shadow-md transition-all transform hover:scale-105"
                  >
                  ...
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white flex items-center p-2 rounded-full shadow-md transition-all transform hover:scale-105"
                  >
                    <Plus size={18} className="m-2" />
                  </button>
                )}
